...
import { Check, Copy, FilterX, Plus, Search, UserRound } from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      <section className={`rounded-3xl border p-6 shadow-sm ${isAdmin ? 'border-amber-200 bg-[linear-gradient(135deg,#fff7ed_0%,#fffbeb_45%,#ffffff_100%)]' : 'border-blue-200 bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_60%,#f8fafc_100%)]'}`}>
