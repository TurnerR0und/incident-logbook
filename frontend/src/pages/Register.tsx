...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top_right,#064e3b_0%,#052e2b_35%,#020617_100%)] px-4 py-10 sm:px-6 lg:px-8">
      <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white p-8 text-slate-900 shadow-2xl shadow-slate-950/30 sm:p-10">
        <div>
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-950">Create account</h1>
          <p className="mt-3 text-sm leading-6 text-slate-500">
            Register for access to the incident workspace.
          </p>
        </div>
